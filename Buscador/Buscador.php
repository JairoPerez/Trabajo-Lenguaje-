            ...
            <tbody>
                <?php
                    while($rows = $stmt->fetch(PDO::FETCH_ASSOC)){
                        ...
                        echo "<td>";
                        echo '<button type="button" onclick="window.location.href = \'modificar_alumno.php?nia='.$rows['nia'].'\'">Modificar</button>';
                        echo '<button type="button" class="delete-button" data-nia="' . $rows['nia'] . '">Borrar</button>';
                        echo "</td>";
                        echo "</tr>";
                    }
                ?>
